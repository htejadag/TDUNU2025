...
/**
 * Controlador REST encargado de la gestión de seguimientos.
 *
 * Expone endpoints para realizar operaciones CRUD y consultas
 * relacionadas con el seguimiento de entidades dentro del
 * microservicio. La información de catálogo y auditoría
 * utilizada es propia del dominio del microservicio.
 */
@Slf4j
@RestController
@AllArgsConstructor
...
public class SeguimientoController {
    ...
    /**
     * Servicio de negocio para la gestión de seguimientos.
     */
     ...
     *
     * @return respuesta con la lista de seguimientos
     */
     ...
     *
     * @param request datos del seguimiento a registrar
     * @return respuesta con el seguimiento creado
     */
    @PostMapping(value = ApiRoutes.Seguimiento.GUARDAR)
    public ResponseBase<SeguimientoResponse> guardar(
        ...
        SeguimientoResponse response =
                seguimientoService.guardar(request);
    ...
    /**
     * Elimina un seguimiento según su identificador.
     *
    ...
    /**
     * Actualiza la información de un seguimiento existente.
     *
     * @param id identificador del seguimiento a actualizar
     * @param request datos actualizados del seguimiento
     * @return respuesta con el seguimiento actualizado
     */
    ...
    public ResponseBase<SeguimientoResponse> actualizar(
        ...
        SeguimientoResponse response =
                seguimientoService.actualizar(id, request);
    ...
    /**
     * Obtiene un seguimiento según su identificador.
     *
     * @param id identificador del seguimiento
     * @return respuesta con el seguimiento encontrado
     */
    @GetMapping(value = ApiRoutes.Seguimiento.OBTENER_POR_ID)
    public ResponseBase<SeguimientoResponse> obtenerPorId(
            @RequestParam(value = "id") Integer id) {
        ...
        SeguimientoResponse response =
                seguimientoService.obtenerPorId(id);
    ...
    /**
     * Busca seguimientos asociados a una entidad del sistema.
     *
     * @param idEntidadCatalogo identificador del catálogo de la entidad
     * @param entidadId identificador de la entidad
     * @return respuesta con la lista de seguimientos encontrados
     */

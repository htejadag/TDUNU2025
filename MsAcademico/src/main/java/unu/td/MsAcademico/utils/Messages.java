...
public class Messages {
    ...
    public static final String REQUIRED_ID_USUARIO = "El id del usuario es requerido";
    public static final String REQUIRED_ID_TIPO_AUTORIDAD = "El id del tipo de autoridad es requerido";
    ...
    public static final String INVALID_FECHA_INICIO = "La fecha inicio no puede ser una fecha futura";
    public static final String INVALID_FECHA_FIN = "La fecha fin no puede ser una fecha futura";

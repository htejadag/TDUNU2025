...
public class ApiRoutes {
    ...
    public static class Asistencia {
        ...
        public static final String BUSCAR_POR_EVENTO = "/buscarPorEvento";
        public static final String BUSCAR_POR_FECHA = "/buscarPorFecha";
    }

    public static class AsistenciaAlumno {
        public static final String BASE = "/api/asistencia-alumno";
        public static final String LISTAR = "/listar";
        public static final String OBTENER_POR_ID = "/obtenerPorId";
        public static final String GUARDAR = "/guardar";
        public static final String ELIMINAR = "/eliminar";
        public static final String BUSCAR_POR_ALUMNO = "/buscarPorAlumno";
    }

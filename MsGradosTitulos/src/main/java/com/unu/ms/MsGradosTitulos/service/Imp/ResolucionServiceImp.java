...
import com.unu.ms.MsGradosTitulos.model.mapper.ResolucionMapper;
...
public class ResolucionServiceImp implements ResolucionService {
    ...
    public List<ResolucionResponse> buscarPorExpediente(Integer idExpediente) {
        return resolucionRepository.findByExpediente(idExpediente).stream().map(mapper:: toResponse).toList();
    }

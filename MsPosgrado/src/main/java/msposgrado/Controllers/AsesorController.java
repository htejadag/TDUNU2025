...
@RestController
@RequestMapping(Routes.ASESORES)
...
public class AsesorController {
    ...
    public Asesor obtenerPorId(
            @Parameter(description = "ID del asesor a buscar", required = true) @PathVariable Integer id) {
    ...
    public Asesor crear(
            @io.swagger.v3.oas.annotations.parameters.RequestBody(description = "Datos del nuevo asesor", required = true) @Valid @RequestBody Asesor asesor) {
    ...
    public void eliminar(
            @Parameter(description = "ID del asesor a eliminar", required = true) @PathVariable Integer id) {
        service.eliminar(id);
    }
}

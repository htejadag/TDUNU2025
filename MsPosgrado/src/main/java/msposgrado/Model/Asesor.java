...
@Entity
@Table(name = "asesor")
@Schema(description = "Entidad que representa a un asesor académico de posgrado")
public class Asesor extends AuditoriaEntity {

    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    @Schema(
        description = "Identificador único del asesor",
        example = "1",
    ...
    @Schema(
        description = "Nombres completos del asesor",
        example = "Juan Carlos"
    )
    ...
    @Schema(
        description = "Apellidos completos del asesor",
        example = "Pérez Gómez"
    )
    ...
    @Schema(
        description = "Grado académico máximo alcanzado",
        example = "Doctor"
    )
    ...
    @Schema(
        description = "Ruta del archivo del currículum vitae",
        example = "archivos/cv/asesor1.pdf"
    )
    ...
    @Schema(
        description = "Ruta del archivo de la declaración jurada",
        example = "archivos/declaracion/asesor1.pdf"
    )
    private String declaracionRuta;

    @Size(max = 20, message = "El estado no puede superar los 20 caracteres")
    @Schema(
        description = "Estado actual del asesor",
        example = "ACTIVO"
    )

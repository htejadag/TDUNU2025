...
public class DocumentoController {
    ...
    public ResponseEntity<Documento> crear(@io.swagger.v3.oas.annotations.parameters.RequestBody(description = "Datos del nuevo documento", required = true) @Valid @RequestBody Documento documento) {
    ...
    public ResponseEntity<Documento> obtener(@Parameter(description = "ID del documento a buscar", required = true) @PathVariable Integer id) {
    ...
    public ResponseEntity<Void> eliminar(@Parameter(description = "ID del documento a eliminar", required = true) @PathVariable Integer id) {
        Documento d = service.obtenerPorId(id);
        if (d == null) {
            return ResponseEntity.notFound().build();
        }

...
public class GlobalExceptionHandler {
  ...
  // Error por restricciones de BD (duplicados, FK, etc.)
  ...
  // Errores genéricos de persistencia (JPA)
  ...
  public ResponseEntity<ResponseBase<Object>> handlePersistence(PersistenceException ex) {
    ...
    return ResponseEntity
        .status(HttpStatus.INTERNAL_SERVER_ERROR)
        .body(ResponseBase.error("Error al acceder a la base de datos"));
  }
  ...
  // Error de conversion de atributos
